...
F_NAME1 = 'test_data_subject.pkl'
F_NAME2 = 'train_data_subject.pkl'
...
for d in data:
    ...
    ax.scatter(x[3], x[7], Z, cmap=cm.jet)
    ax.set_xlabel('distance')
    ax.set_ylabel('velocity')
    ax.set_zlabel('variable')
    plt.savefig('subject_surface/'+subject+'dis_vel.png')
    # plt.show()